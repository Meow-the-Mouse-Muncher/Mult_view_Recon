...
class Rays:
  ...
  origins: torch.Tensor  # The origins of the rays
  directions: torch.Tensor  # The normalized directions
  base_radius: Optional[torch.Tensor] = None  # If we want to cast a cone
...
class ReferenceViews:
  ...
  ref_cameratoworld: torch.Tensor  # shape [... 4 4]
  ref_worldtocamera: torch.Tensor  # shape [... 4 4]
  intrinsic_matrix: torch.Tensor  # shape [... 3 4]
