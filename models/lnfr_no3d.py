...
class LFNR(nn.Module):
    ...
    def _get_query(self, rays_o, rays_d):
        ...
        return q_enc
    def _get_key(self, projected_rgb_and_feat, ref_rays_o, ref_rays_d):
    ...
    def forward(self, batch):
        ...
        projected_rgb_and_feat = self._get_pixel_projection(sampling_grid,
                                                    ref_images)
        input_k = self._get_key(projected_rgb_and_feat,ref_rays_o, ref_rays_d) # [B, N, n_rays, k_dim] k_dim=130
